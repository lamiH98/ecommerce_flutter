      ...
      body: Padding(
        ...
        child: ListView(
          ...
          children: [
                              ...
                              Get.defaultDialog(
                                ...
                                content: Column(
                                  children: [
                                    TextButton(
                                      onPressed: () {
                                        productController.categoryProductList.sort((a, b) {
            ...
            Obx(() {
              if(productController.isCategoryProductLoading.value)
                return Center(child: CircularProgressIndicator());
              else
                return productController.categoryProductList.length > 0 ?  StaggeredGridView.countBuilder(
                  ...
                  itemBuilder: (BuildContext context, int index) {
                    var product = productController.categoryProductList[index];
                        ...
                        child: Card(
                          child: Column(
                            ...
                            children: [
                              Stack(
                                children: [
                                  cachedNetworkImage('$image_api${product.image}', context, 165, width: MediaQuery.of(context).size.width),
                  ...
                  child: Center(child: CustomText(text: 'no_items'.tr, fontSize: 18.0, fontWeight: FontWeight.bold)),
                );
            })
          ],
        ),
